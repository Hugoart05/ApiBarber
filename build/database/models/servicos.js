    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tabelas_1.servicos.create({
                            nome: nome,
                        })];
                case 3:
                    _b.sent();
...
function pesquisarServico(nome) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, tabelas_1.servicos.findOne({ where: { nome: nome } })];
                case 1:
                    valida = _a.sent();
                    if (valida === null) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tabelas_1.servicos.destroy({ where: { nome: nome } })];
                case 3:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, tabelas_1.servicos.findOne({ where: { id: id } })];
                case 1:
                    valida = _a.sent();
                    if (!(valida === null)) return [3 /*break*/, 2];
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tabelas_1.servicos.update({
                            preco: preco
                        }, {
                            where: { id: id }
                        })];
