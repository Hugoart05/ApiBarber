    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tabelas_1.usuarios.create({
                            nome: nome,
                            email: email,
                            telefone: telefone,
                            senha: senha,
...
function pesquisarEmail(email) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, tabelas_1.usuarios.findOne({ where: { email: email } })];
                case 1:
                    validaEmail = _a.sent();
                    if (validaEmail === null) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tabelas_1.usuarios.update({
                            nome: nome,
                            telefone: telefone,
                            senha: senha
                        }, {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tabelas_1.usuarios.destroy({ where: { email: email } })];
                case 3:
                    _a.sent();
