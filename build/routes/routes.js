...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get.apply(app, __spreadArray(__spreadArray(__spreadArray(['/usuarios'], ((0, runtime_1.fetchMiddlewares)(usuarioController_1.UsuarioController)), false), ((0, runtime_1.fetchMiddlewares)(usuarioController_1.UsuarioController.prototype.getUsuario)), false), [function UsuarioController_getUsuario(request, response, next) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            controller = new usuarioController_1.UsuarioController();
