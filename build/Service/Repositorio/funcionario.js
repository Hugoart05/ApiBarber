...
function adicionarFuncionario(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Usuarios_1.usuarios.findByPk(id)];
                case 1:
                    usuario = _a.sent();
                    if (usuario === null) {
                        return [2 /*return*/, { status: false, mensagem: ' usuario não encontrado' }];
                    }
                    return [4 /*yield*/, Funcionario_1.funcionarios.findByPk(id)];
                case 2:
                    result = _a.sent();
                    if (!(result === null)) return [3 /*break*/, 4];
                    return [4 /*yield*/, Funcionario_1.funcionarios.create({
                            usuario_id: id
                        })];
                case 3:
                    _a.sent();
...
function deletarFuncionario(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Funcionario_1.funcionarios.findOne({ where: { id: id } })];
                case 1:
                    valida = _a.sent();
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, Funcionario_1.funcionarios.destroy({ where: { id: id } })];
                case 3:
                    _a.sent();
